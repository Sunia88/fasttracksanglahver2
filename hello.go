...
func getCM(w http.ResponseWriter, r *http.Request){
    ...
    {{with .NamaPasien}}<input type="text" name="namapasien" id="nocm" class="form-control text-capitalize" value={{.}}><br>
	{{else}}
	<input type="text" name="namapasien" id="nocm" class="form-control text-capitalize" value=""><br>
	{{end}}
	...
	<label for="" class="radio-inline"><input type="radio" name="iki" id="" value="2">IKI 2</label><br>
	...
	<button type="submit">Tambahkan Pasien</button>
   `
